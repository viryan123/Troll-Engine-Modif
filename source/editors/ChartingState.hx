...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Camera Bop Speed',"Basically just does what the name says\nvalue 1: intensity\nvalue 2: speed"],
	...
	**/
	...
	override function create()
	{
		...
		for (i in 0...8){
			var note:StrumNote = new StrumNote(GRID_SIZE * (i+1), strumLine.y, i % 4, _song.arrowSkinbf);
	...
	function addSongUI():Void
	{
		...
		noteSplashesInputText = new FlxUIInputText(player2DropDown.x, player2DropDown.y + 35, 150, _song.splashSkin, 8);
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		var note:Note = new Note(daStrumTime, daNoteInfo % 4, null, null, true, PlayState.arrowSkinbf);
