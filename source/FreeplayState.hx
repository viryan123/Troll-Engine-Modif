...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText.setFormat(Paths.font("Bold Normal Text.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		text.setFormat(Paths.font("Bold Normal Text.ttf"), size, FlxColor.WHITE, RIGHT);
	...
	{
		var mData = new SongMetadata(songName, weekNum, songCharacter, color);
		mData.diff = diff;
		songs.push(mData);
		return mData;
	}
	...
	function changeSelection(change:Int = 0, playSound:Bool = true)
	{
		...
		var diffStr:String = songs[curSelected].diff;
		if (diffStr != null)
...
{
	var freeplayCats:Array<String> = ['Vanila'];
