...
class NotesSubState extends MusicBeatSubstate
{
	...
	private var shaderArray:Array<AmongUsColorSwapShader> = [];
...
/* 		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('newmenuu/optionsbg'));
		...
		for (i in 0...ClientPrefs.arrowHSV.length) {
			...
			var newShader:AmongUsColorSwapShader = new AmongUsColorSwapShader();
			...
			newShader.red = ClientPrefs.coloumColors[i][0];
			newShader.green = 0xffffff;
			newShader.blue = ClientPrefs.coloumColors[i][1];
