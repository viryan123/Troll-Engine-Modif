...
class NotesPresetSubSubState extends MusicBeatSubstate
{
	...
	function changePreset(change:Int = 0) {
		...
		QuantNotesSubState.quantColors = presetMap[presets[curPreset]];
	...
	function loadNotes() {
		...
		var quantBeatText:Array<String> = ['4th', '8th', '12th', '16th', '20th', '24th', '32nd', '48th', '64th','92th', '192nd'];
